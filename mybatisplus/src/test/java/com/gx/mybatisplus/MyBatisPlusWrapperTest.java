...
public class MyBatisPlusWrapperTest {
	...
	public void test08() {
		...
		updateWrapper.like("user_name", "a")
				.and(i->i.gt("age", 20).or().isNull("email"));
		updateWrapper.set("user_name", "xh1").set("email", "abc@xh.com");
	...
	public void test11(){
		...
		queryWrapper.like(com.baomidou.mybatisplus.core.toolkit.StringUtils.isNotBlank(username), User::getName, username)
	...
	public void test12(){
		...
		updateWrapper.set(User::getName, "xh").set(User::getEmail,"abc@atguigu.com");
		int result = userMapper.update(null, updateWrapper);
		System.out.println("result："+result);
	}
}
